...
public class SpellCheckerTest {
	...
	{
		DictionaryHash dict = DictionaryHash.make(fdict);
		Corrector corr = null;
		if (fcorr == null) {
	...
	@Test(timeout=500) public void testCheckFoxGood() throws IOException, FileCorrector.FormatException {
		spellCheckFiles("data/theFoxDictionary.txt",7,"data/theFoxMisspellings.txt",
				"data/theFox.txt","data/foxout.txt","data/theFox_goodinput.txt");
		compareDocs("data/foxout.txt", "data/theFox_expected_output.txt");
	}


	@Test(timeout=500) public void testCheckMeanInput() throws IOException, FileCorrector.FormatException {
		spellCheckFiles("data/theFoxDictionary.txt",7,"data/theFoxMisspellings.txt",
				"data/theFox.txt","data/foxout.txt","data/theFox_meaninput.txt");
		compareDocs("data/foxout.txt", "data/theFox_expected_output.txt");
	}
	...
	@Test(timeout=500) public void testCheckGettysburgSwap() throws IOException, FileCorrector.FormatException {
		...
		spellCheckFiles("data/dictionary.txt",60822,null,
				"data/Gettysburg.txt","data/Gettysburg-out.txt",
				"data/Gettysburg_input.txt");
		compareDocs("data/Gettysburg-out.txt", "data/Gettysburg_expected_output.txt");
	}
